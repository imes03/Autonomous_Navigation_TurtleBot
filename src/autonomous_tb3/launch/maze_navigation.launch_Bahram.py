...
def generate_launch_description():
    ...
    maze_path = os.path.join(get_package_share_directory('autonomous_tb3'),'world','small_maze','model.sdf')
  ...
  #  slam_params_file = os.path.join(get_package_share_directory('autonomous_tb3'), 'config', 'slam_toolbox_params.yaml')  #for modification of SlamToolbox
    ...
    x_pose = LaunchConfiguration('x_pose', default='1.2')   #red axis
    y_pose = LaunchConfiguration('y_pose', default='-0.7')   #green axis

    world = os.path.join(
        get_package_share_directory('autonomous_tb3'),
        'world/small_maze/model.sdf'
    )
